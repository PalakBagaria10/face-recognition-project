...
class Face_Recognition:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"College_images\Top.jpg")
        ...
        #second image
        img1=Image.open(r"College_images\top1.jpg")
        ...
        #third image
        img2=Image.open(r"College_images\top3.jpg")
        ...
        #bg image
        img3=Image.open(r"College_images\bg.jpeg")
        ...
        b2.place(x=1100,y=300,width=220,height=40)
          ...
          #train face button
        img8=Image.open(r"College_images\train_data.jpg")
        ...
        b2.place(x=200,y=600,width=220,height=40)
          ...
          #Photos button
        img9=Image.open(r"College_images\photo.jpeg")
